<!--
 * @Author: WCL
 * @Date: 2022-01-17 17:08:20
 * @LastEditors: WCL
 * @LastEditTime: 2022-01-17 17:09:22
 * @FilePath: \webgis\src\views\monitor\carrycapacity\vue\CarryCapacity.vue
 * @Description: 请填写描述
-->
<template>
...
<script>
export { default } from '../js/carrycapacity'
</script>

<style scoped lang="scss">
@import '../style/carrycapacity.scss';
</style>